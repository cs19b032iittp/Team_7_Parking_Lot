...
class Spot {
    ...
    // Constructor that takes Spot number and isElectic status as input
    public Spot(int spotNo, boolean isElectric) {
        this.spotNo = spotNo;
        this.isElectric = isElectric ;
    }
    // returns the Spot number of the Spot object
    public int getSpotNo() {
        return this.spotNo;
    }
    // returns whether the Spot is Electic
    public boolean isElectric() {
        return this.isElectric ;
    }
    // sets the Electic status of Spot to true or false
    public void setElectric(boolean status) {
        this.isElectric  = status;
    }
    // returns if the Spot is available for booking or is already reserved
    public boolean isReserved() {
        return this.isReserved;
    }
    // set the status (Reserved or not) of the Spot
...
class Floor {
    ...
    // returns the array of Spots that are NOT reserved
    ...
    // returns array all Spots [Both reserved and unreserved]
    public Spot[] getAllSpots() {
        return r;
    }
    // takes the Spot number as an input and returns the corresponding Spot object
    ...
    /** Modifies the Electic status of spot.
     Takes Spot number and Electic-status as input and sets
     the Electic status of corresponding Spot to true/false
     outputs true incase of successful operation.
     Incase of invalid inputs (like trying to set a non existant Spot)
    ...
    /** Adds a new Spot to the Floor. Returns a true upon successful add.
     Returns false in-case of illegal operation like trying to add a Spot with
     existing Spot Number OR in-case of unsuccessful add operation */
    ...
    /**Removes an existingSpot taking Room number as input. Returns a true incase
     of successful deletion. Incase of unsuccessful deletion or illegal operation
     like trying to remove a non-existing Spot, the function returns a false */
    public boolean removeSpot(int spotNo) {
        ...
        return false;
    } /**Should set the status of any unreserved non-Electic Spot to true. Incase all Spots
     are reserved, it should return a false which implies that booking was unsuccessful
     ONLY NON-Electic SpotS can be booked using this function */
    public boolean bookRegularSpot() {
        ...
        return false;
    } /**Overloaded function for booking a Spot that takes a specific Spot number as Input.
     Return a true on successful booking. Return a false in-case the Spot with the given
     number was already reserved, doesn't exist or is Electic Spot.
     ONLY NON-Electic SpotS can be booked using this function */
    ...
    /**Should set the status of any unreserved Electic Spot to true. Incase all Electic Spots
     are reserved, it should return a false which implies that booking was unsuccessful
     ONLY Electic SpotS can be booked using this function */
    public boolean bookElectricSpot() {
        ...
        return false;
    } /**Overloaded function for booking anElectic-Spot that takes a specific Spotnumber as Input.
     Return a true on successful booking. Return a false in-case the Spot with the given
     number was already reserved, doesn't exist or is non-Electic Spot.
     ONLY Electic SpotS can be booked using this function */
    public boolean bookElectricSpot(int spotNo) {
        ...
        return false;
    }/**Return true if any unreserved Electic Spot is availabe, false otherwise */
        ...
        while(T == 5) {
            ...
            if(signin == 1){
                ...
                if(Option == 1){
                    ...
                    System.out.println("\nEnter the spot number u want to book");
                    int bookspot = sc.nextInt();
                    ra[bookspot].setReservedStatus(true);
                }
                else if(Option == 6){
            ...
            System.out.println("to run press 5");
            T = sc.nextInt();
        }
    }
